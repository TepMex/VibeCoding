...
Release artifacts are published by `.github/workflows/deploy.yml` to project GitHub Pages:
...
| `hsk4-listening-anki` | [hsk4-listening-anki](https://tepmex.github.io/VibeCoding/hsk4-listening-anki/) | HSK 4 Listening · 509 offline audio cards for Anki (`.apkg`) |
