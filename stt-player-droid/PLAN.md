...
- Повторить функции PWA: MP3, TXT/HTML/EPUB/FB2, недавние файлы, главы, восстановление позиции, ±10 секунд (UI и media notification), журнал производительности и подсветка найденного фрагмента.
